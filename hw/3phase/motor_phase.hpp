...
class MotorPhase {
    public:
         ...
         */
        virtual JupiterStatus init(bool hall_sense_enabled) = 0;

        /**
         * @brief Set the phase cmds
         * @param a The phase A cmd
         * @param b The phase B cmd
         * @param c The phase C cmd
         * @return JupiterStatus The status of the operation
         */
         ...
         * @return JupiterStatus The status of the operation
         */
        virtual JupiterStatus read_hall_sensors(hall_sense& hall_sense) = 0;
