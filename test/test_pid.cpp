...
TEST(PIDTest, integral_gain_test) {
    ...
    // Expect a call to get_time_us() to return 22 * microseconds_per_second
    ...
    // Expect a call to get_time_us() to return 24 * microseconds_per_second
...
TEST(PIDTest, derivative_gain_test) {
    ...
    // Expect a call to get_time_us() to return 7 * microseconds_per_second
    ...
    // Expect a call to get_time_us() to return 9 * microseconds_per_second
